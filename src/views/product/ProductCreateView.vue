      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="bg-white border border-border rounded-2xl p-6">
          ...
          <div class="flex gap-3 flex-wrap">
            ...
            <div v-for="(src, index) in images" :key="index" class="relative w-24 h-24 rounded-xl overflow-hidden">
        ...
        <div class="grid grid-cols-2 gap-4 pb-6">
          <button class="py-4 rounded-xl border border-border text-text-main font-semibold hover:bg-gray-50">취소</button>
          <button @click="submitForm" class="py-4 rounded-xl bg-primary text-white font-semibold hover:bg-primary-hover">등록하기</button>
        </div>
      </div>
    </div>
  </div>
